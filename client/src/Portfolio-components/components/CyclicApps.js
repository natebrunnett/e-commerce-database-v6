...
function CyclicApps() {
    ...
    return (
        ...
        <div>
            <div onClick={() => navigate('/Ecommerce')} className='flex flex-col items-center cursor-pointer'>
            ...
            <div onClick={() => navigate('/Spotify')} className='flex flex-col items-center cursor-pointer'>
